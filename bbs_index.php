...
<html>
    <head>
        ...
        名前:<br>
        <input type="text" placeholder="name" name="users_names" size="40">
        </p>
        
        <p>
        コメント: <br>
        <textarea placeholder="comment" name="users_comments" rows="4" cols="50"></textarea>
        </p>
        ...
        <?php foreach($data as $row){ ?>
            <tr>
            <td><?php echo htmlentities( $row['users_names'], ENT_QUOTES, 'UTF-8');?></td>
            <td><?php echo htmlentities( $row['users_comments'], ENT_QUOTES, 'UTF-8');;?></td>
            <td>
